package com.example.crud_mysqlsis21b;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setSubtitle("JAVA-ANDROID 2019");
        toolbar.setSubtitleTextColor(getResources().getColor(R.color.mycolor));
        toolbar.setTitle("FRAN CEREAL");
    ...
    public String getSharedCodigo(Context context) {
        SharedPreferences preferences = context.getSharedPreferences("FranCereal", MODE_PRIVATE);
